...
import com.aayush.pim.interactor.ReservationService;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        ...
        List<RoomReservationModel> mockReservationList = new ArrayList<>();
        RoomReservationModel mockRoomReservation = new RoomReservationModel();
